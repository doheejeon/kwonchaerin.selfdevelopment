...
function loginCheck(){
	...
	$.ajax({
        ...
        success: function(result) {
        	if(result == 1) {
        		location.href = "/kwonchaerin.selfdevelopment/";
        	} else if(result == 2) {
        		location.href = "/kwonchaerin.selfdevelopment/admin";
        	} else {
        		location.href = "/kwonchaerin.selfdevelopment/user/login";
		...
		<div class='row my-5'>
			<div class='col'>
				...
				<div class='row text-center my-3'>
					<a href='/kwonchaerin.selfdevelopment/user/account/step1' class='col text-dark'> 아이디 & 비밀번호 찾기 </a>
				</div>
				<hr>
				...
				<div class='row text-center'>
					<a href='/kwonchaerin.selfdevelopment/user/join/step1' class='col mt-2 text-dark'> 회원 가입하기 </a>
				</div>
			</div>
		</div>
	</div>
